 ...
 * @author rudr'a
 */
public class Classes_4 extends javax.swing.JFrame {

    /**
     * Creates new form Classes_4
     */
    public Classes_4() {
    ...
    conn=JavaConnect.ConnectDB();
        try
        {
            ...
            update table
            */
         String sql="select * from Student_Info_4 order by Student_id";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
