 ...
 * @author rudr'a
 */
public class Classes_7 extends javax.swing.JFrame {

    /**
     * Creates new form Classes_7
     */
    public Classes_7() {
    ...
    conn=JavaConnect.ConnectDB();
        try
        {
            ...
            update table
            */
         String sql="select * from Student_Info_7 order by Student_id";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
