...
public class Class_2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_middle_name.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
    ...
    conn=JavaConnect.ConnectDB();
     String sql="select * from Student_Info_2 where Student_id=?";
     try
     {
    ...
    try
    {
        if(aa.isEmpty())
           ...
           {
            String sql="update Student_Info_2 set Last_Name='"+a+"',First_Name='"+b+"',Middle_Name='"+c+"',Standard='"+d+"',Batch='"+e+"',D_O_B='"+f+"',Gender='"+g+"',Age='"+h+"',Mob='"+i+"',Address='"+j+"',Fill_fees='"+k+"',Remain_fees='"+l+"',Total_fees='"+m+"' where Student_id='"+aa+"'";
             pst=conn.prepareStatement(sql);
            pst.execute();
