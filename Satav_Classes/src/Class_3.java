...
public class Class_3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(clear_btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 570, 110, 30));
    ...
    conn=JavaConnect.ConnectDB();
     String sql="select * from Student_Info_3 where Student_id=?";
     try
     {
    ...
    try
    {
        if(aa.isEmpty())
           ...
           {
            String sql="update Student_Info_3 set Last_Name='"+a+"',First_Name='"+b+"',Middle_Name='"+c+"',Standard='"+d+"',Batch='"+e+"',D_O_B='"+f+"',Gender='"+g+"',Age='"+h+"',Mob='"+i+"',Address='"+j+"',Fill_fees='"+k+"',Remain_fees='"+l+"',Total_fees='"+m+"' where Student_id='"+aa+"'";
             pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    try
        {
            ...
            String sql="delete from Student_Info_2 where Student_id='"+ab+"'";
            pst=conn.prepareStatement(sql);
