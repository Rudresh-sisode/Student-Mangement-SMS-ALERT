 ...
 * @author rudr'a
 */
public class Classes_9 extends javax.swing.JFrame {

    /**
     * Creates new form Classes_9
     */
    public Classes_9() {
    ...
    conn=JavaConnect.ConnectDB();
        try
        {
            ...
            update table
            */
         String sql="select * from Student_Info_9 order by Student_id";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
