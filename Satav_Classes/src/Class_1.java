...
public class Class_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fill_up_fees.setEditable(false);
        ...
        remaining_fees.setEditable(false);
        ...
        btn_search.setBackground(new java.awt.Color(22, 101, 158));
        btn_search.setFont(new java.awt.Font("Book Antiqua", 0, 24)); // NOI18N
        ...
        jPanel1.add(btn_search, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 30, 110, 30));
        ...
        clear_btn2.setBackground(new java.awt.Color(22, 101, 158));
        clear_btn2.setFont(new java.awt.Font("Book Antiqua", 0, 24)); // NOI18N
        clear_btn2.setForeground(new java.awt.Color(255, 255, 255));
        clear_btn2.setText("Table");
        clear_btn2.setToolTipText("View Table");
        ...
        jPanel1.add(clear_btn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 580, 110, 30));
    ...
    try
    {
        if(aa.isEmpty())
           ...
           {
            String sql="update Student_Info set Last_Name='"+a+"',First_Name='"+b+"',Middle_Name='"+c+"',Standard='"+d+"',Batch='"+e+"',D_O_B='"+f+"',Gender='"+g+"',Age='"+h+"',Mob='"+i+"',Address='"+j+"',Fill_fees='"+k+"',Remain_fees='"+l+"',Total_fees='"+m+"' where Student_id='"+aa+"'";
             pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    try
        {
            ...
            String sql="delete from Student_Info where Student_id='"+ab+"'";
            pst=conn.prepareStatement(sql);
