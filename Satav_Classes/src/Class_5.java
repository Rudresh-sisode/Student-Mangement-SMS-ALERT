 ...
 * @author User
 */
public class Class_5 extends javax.swing.JFrame {

    /**
     * Creates new form Class_5
     */
    ...
    private void initComponents() {
        ...
        clear_btn.setText("Table");
        clear_btn.setToolTipText("View Table");
        ...
        jPanel1.add(clear_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 580, 110, 30));
        ...
        clear_btn1.setToolTipText("Clear");
        ...
        jPanel1.add(clear_btn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 530, 110, 30));
    ...
    private void fill_up_feesKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fill_up_feesKeyReleased
        ...
        String a=total_fees.getText();
        String b=fill_up_fees.getText();
        int aa=Integer.parseInt(a);
        int bb=Integer.parseInt(b);
        int c=aa-bb;
        String str=Integer.toString(c);
        remaining_fees.setText(str);
    ...
    conn=JavaConnect.ConnectDB();
     String sql="select * from Student_Info_5 where Student_id=?";
     try
     {
    ...
    try
    {
        if(aa.isEmpty())
           ...
           {
            String sql="update Student_Info_5 set Last_Name='"+a+"',First_Name='"+b+"',Middle_Name='"+c+"',Standard='"+d+"',Batch='"+e+"',D_O_B='"+f+"',Gender='"+g+"',Age='"+h+"',Mob='"+i+"',Address='"+j+"',Fill_fees='"+k+"',Remain_fees='"+l+"',Total_fees='"+m+"' where Student_id='"+aa+"'";
             pst=conn.prepareStatement(sql);
            pst.execute();
    ...
    try
        {
            ...
            String sql="delete from Student_Info_5 where Student_id='"+ab+"'";
            pst=conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class_5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
