 ...
 * @author rudr'a
 */
public class Classes_8 extends javax.swing.JFrame {

    /**
     * Creates new form Classes8
     */
    public Classes_8() {
    ...
    conn=JavaConnect.ConnectDB();
        try
        {
            ...
            update table
            */
         String sql="select * from Student_Info_8 order by Student_id";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
