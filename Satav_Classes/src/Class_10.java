 ...
 * @author User
 */
public class Class_10 extends javax.swing.JFrame {

    /**
     * Creates new form Class_10
     */
    ...
    private void initComponents() {
        ...
        jPanel1.add(update_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 440, 112, 30));
        ...
        jPanel1.add(clear_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 520, 110, 30));

        TABLE.setBackground(new java.awt.Color(22, 101, 158));
        TABLE.setFont(new java.awt.Font("Book Antiqua", 0, 24)); // NOI18N
        TABLE.setForeground(new java.awt.Color(255, 255, 255));
        TABLE.setText("Table");
        TABLE.setToolTipText("View Table");
        ...
        jPanel1.add(TABLE, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 560, 110, 30));
    ...
    private void Search_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Search_btnActionPerformed
        ...
        String sql="select * from Student_Info_10 where Student_id=?";
        try
        {
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
        ...
        try
        {
            ...
            {
                String sql="update Student_Info_10 set Last_Name='"+a+"',First_Name='"+b+"',Middle_Name='"+c+"',Standard='"+d+"',Batch='"+e+"',D_O_B='"+f+"',Gender='"+g+"',Age='"+h+"',Mob='"+i+"',Address='"+j+"',Fill_fees='"+k+"',Remain_fees='"+l+"',Total_fees='"+m+"' where Student_id='"+aa+"'";
                pst=conn.prepareStatement(sql);
                pst.execute();
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                String sql="delete from Student_Info_10 where Student_id='"+ab+"'";
                pst=conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class_10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
