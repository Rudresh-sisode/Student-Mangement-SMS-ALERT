 ...
 * @author rudr'a
 */
public class Classes_1 extends javax.swing.JFrame {

    /**
     * Creates new form Classes_1
     */
    public Classes_1() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
