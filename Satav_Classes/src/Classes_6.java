 ...
 * @author rudr'a
 */
public class Classes_6 extends javax.swing.JFrame {

    /**
     * Creates new form Classes_6
     */
    public Classes_6() {
    ...
    conn=JavaConnect.ConnectDB();
        try
        {
            ...
            update table
            */
         String sql="select * from Student_Info_6 order by Student_id";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
