 ...
 * @author rudr'a
 */
public class Classes_3 extends javax.swing.JFrame {

    /**
     * Creates new form Classes_3
     */
    public Classes_3() {
    ...
    conn=JavaConnect.ConnectDB();
        try
        {
            ...
            update table
            */
         String sql="select * from Student_Info_3 order by Student_id";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Classes_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
