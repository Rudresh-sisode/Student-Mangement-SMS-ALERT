 ...
 * @author User
 */
public class Class_9 extends javax.swing.JFrame {

    /**
     * Creates new form Class_9
     */
    ...
    private void Search_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Search_btnActionPerformed
        ...
        String sql="select * from Student_Info_9 where Student_id=?";
        try
        {
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
        ...
        try
        {
            ...
            {
                String sql="update Student_Info_9 set Last_Name='"+a+"',First_Name='"+b+"',Middle_Name='"+c+"',Standard='"+d+"',Batch='"+e+"',D_O_B='"+f+"',Gender='"+g+"',Age='"+h+"',Mob='"+i+"',Address='"+j+"',Fill_fees='"+k+"',Remain_fees='"+l+"',Total_fees='"+m+"' where Student_id='"+aa+"'";
                pst=conn.prepareStatement(sql);
                pst.execute();
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                String sql="delete from Student_Info_9 where Student_id='"+ab+"'";
                pst=conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Class_9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
